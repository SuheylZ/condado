<%@ Control Language="C#" AutoEventWireup="true" CodeFile="OverrideEmailAttachments.ascx.cs"
    Inherits="UserControls_OverrideAccountAttachments" %>
                ...
                <tr style="vertical-align: top">
                    <td>
                        ...
                        <telerik:RadAsyncUpload ID="fUploadAsync" runat="server" UploadedFilesRendering="BelowFileInput" MaxFileSize="0"
                            MaxFileInputsCount="1"  Height="27px" Width="320px" style="direction: ltr">
                        </telerik:RadAsyncUpload>
                        <br/>
                        &nbsp;&nbsp;  <b>Note: File size maximum limit is 100 MB </b>
                        <asp:HiddenField runat="server" ID="hdnFieldEmailTemplateKey" Value="0" />
                        <asp:HiddenField runat="server" ID="hdnFieldEmailQueueKey" Value="0" />
                    ...
                    <td>
                        <asp:Button ID="btnUpload" runat="server" OnClick="btnUpload_Click" Text="Upload"
                            ValidationGroup="Upload" CausesValidation="true" OnClientClick="validateGroup('Upload');" />
                    </td>
                </tr>
            </table>
        </li>
