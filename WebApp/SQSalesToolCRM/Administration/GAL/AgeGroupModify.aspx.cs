...
namespace SQS_Dialer
{
	...
	public partial class AgeGroupModify : SalesBasePage
	{
		...
		{
			AgeGroupManagerDataSource.ConnectionString = CONFIG.ConnectionStrings["ApplicationServices"].ConnectionString;
		...
		{
            AgeGroupManagerDataSource.SelectParameters["bGALType"].DefaultValue = Master.GetGALType().ToString();            
			System.Data.DataView dv = (System.Data.DataView)AgeGroupManagerDataSource.Select(new DataSourceSelectArguments());
            pager.RecordCount = dv.Count;
			//pager.RecordCount = AgeGroupManagerDataSource.RecordCount();
		...
		{
			AgeGroupManagerDataSource.UpdateParameters["age_group_modify_date"].DefaultValue = DateTime.Now.ToString();
		...
		//    //MasterMenu.Items[2].Items[0].Items[1].Selected = true;
		//    Master.GALMenu.Items[2].Items[0].Items[1].Selected = true;
		//}

		protected void btnAdd_Click(object sender, EventArgs e)
		{
			Response.Redirect("AgeGroupAdd.aspx");
		}
