...
{
	public partial class CampaignGroupAdd : SalesBasePage
	{
		...
		{
            CampaignGroupDataSource.InsertParameters["campaign_group_add_date"].DefaultValue = DateTime.Now.ToString();
            CampaignGroupDataSource.InsertParameters["campaign_group_acd_flag"].DefaultValue = Master.GetGALType().ToString();
		}
        ...
        //    Master.GALMenu.Items[1].Items[1].Items[0].Selected = true;
        //}
