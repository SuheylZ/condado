<%@ WebHandler Language="C#" Class="CiscoPhoneService" %>
...
public class CiscoPhoneService : IHttpHandler, System.Web.SessionState.IRequiresSessionState
{
    ...
    public void ProcessRequest(HttpContext context)
    {
        ...
        {
            case "GetPhoneSystem":
                if (context.Session != null && context.Session[Konstants.K_USERID] != null)
                {
                    ...
                    sb.AppendFormat("{0}.{1}",
                    settings.PhoneBarMajorVersionNumber, settings.PhoneBarMinorVersionNumber);

                    foreach (System.Reflection.Assembly a in AppDomain.CurrentDomain.GetAssemblies())
                        if (a.FullName.Contains("PhoneBarUserControl"))
                        {
                            System.Reflection.AssemblyName webName = a.GetName();
                    ...
                    User user = new User();
                    user.PhoneSystem = _user.PhoneCompanyName;
                    user.AssemblyVersion = sb.ToString();
                    JavaScriptSerializer jc = new JavaScriptSerializer();
                    StringBuilder sb1 = new StringBuilder();
                    jc.Serialize(user, sb1);
                    Engine.Dispose();
            ...
            case "HotKeyValues":
                if (context.Session[Konstants.K_USERID] != null)
                {
                    ...
                    {
                        HotKey1ID = settings.CSPhoneSystemHotKey1ID,
                        HotKey1Label = settings.CSPhoneSystemHotKey1Label,
                        HotKey1Type = settings.CSPhoneSystemHotKey1Type,

                        HotKey2ID = settings.CSPhoneSystemHotKey2ID,
                        HotKey2Label = settings.CSPhoneSystemHotKey2Label,
                        HotKey2Type = settings.CSPhoneSystemHotKey2Type,

                        HotKey3ID = settings.CSPhoneSystemHotKey3ID,
                        HotKey3Label = settings.CSPhoneSystemHotKey3Label,
                        HotKey3Type = settings.CSPhoneSystemHotKey3Type,

                        HotKey4ID = settings.CSPhoneSystemHotKey4ID,
                        HotKey4Label = settings.CSPhoneSystemHotKey4Label,
                        HotKey4Type = settings.CSPhoneSystemHotKey4Type,

                        HotKey5ID = settings.CSPhoneSystemHotKey5ID,
                        HotKey5Label = settings.CSPhoneSystemHotKey5Label,
                        HotKey5Type = settings.CSPhoneSystemHotKey5Type,

                        HotKey6ID = settings.CSPhoneSystemHotKey6ID,
                        HotKey6Label = settings.CSPhoneSystemHotKey6Label,
                        HotKey6Type = settings.CSPhoneSystemHotKey6Type,
                    };
