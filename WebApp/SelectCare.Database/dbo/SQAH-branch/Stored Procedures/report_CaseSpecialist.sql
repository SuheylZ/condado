...
Select ROW_NUMBER() over(Order by X.CaseSpecialist) as RowId, X.CaseSpecialist, X.Submitted, X.Pending, X.Approved, X.Declined, X.Withdrawn,
X.NPA, X.Speed
from (
Select 
	 Max(CaseSpecialist) as CaseSpecialist, 
