...
-- Description:	GAL Agent Matrix Data
-- =============================================
CREATE PROCEDURE [dbo].[proj_GetAgentMatrix]
AS
...
Exec [GAL_Rpt_AgentMatrix]
SELECT  agent_name as [Agent Name],'+@DistinctColumnHeadersForSelect +' ,
