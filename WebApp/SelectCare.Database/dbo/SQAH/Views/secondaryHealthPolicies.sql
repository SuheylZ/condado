...
CREATE VIEW [dbo].[secondaryHealthPolicies]
AS
select
	act_key, 
...
from accounts
join Individuals secondaryIndividual on accounts.act_secondary_individual_id = secondaryIndividual.indv_key
join mapdps on mapdp_indv_id = secondaryIndividual.indv_key and madpd_account_id = accounts.act_key
...
from accounts
join Individuals secondaryIndividual on accounts.act_secondary_individual_id = secondaryIndividual.indv_key
join medsups on ms_individual_id = secondaryIndividual.indv_key and ms_account_id = accounts.act_key
...
from accounts
join Individuals secondaryIndividual on accounts.act_secondary_individual_id = secondaryIndividual.indv_key
join dental_vision on den_indv_key = secondaryIndividual.indv_key and den_act_key = accounts.act_key
...
Begin DesignProperties = 
   ...
   End
End
', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'secondaryHealthPolicies';


GO
EXECUTE sp_addextendedproperty @name = N'MS_DiagramPaneCount', @value = 1, @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'secondaryHealthPolicies';
