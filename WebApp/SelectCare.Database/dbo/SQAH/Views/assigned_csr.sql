...
Begin DesignProperties = 
   ...
   Begin CriteriaPane = 
      ...
      Begin ColumnWidths = 11
         ...
         SortType = 1350
         SortOrder = 1410
         GroupBy ', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'assigned_csr';
...
EXECUTE sp_addextendedproperty @name = N'MS_DiagramPane2', @value = N'= 1350
   ...
   End
End
', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'assigned_csr';


GO
EXECUTE sp_addextendedproperty @name = N'MS_DiagramPaneCount', @value = 2, @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'assigned_csr';
