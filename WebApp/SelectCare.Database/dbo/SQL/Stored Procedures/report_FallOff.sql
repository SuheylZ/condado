CREATE procedure [dbo].[report_FallOff](@agentid nvarchar(50)=null, @dt datetime, @skillgroup int, @campaign int)
as
...
Select cast(agent as nvarchar(100)) as Agent, count(diff) as [Count] from @tbl group by agent
