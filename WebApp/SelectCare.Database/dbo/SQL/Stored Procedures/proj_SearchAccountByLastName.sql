...
CREATE procedure [dbo].[proj_SearchAccountByLastName](@phrase nvarchar(50))
As
declare 
...
--Where (U.usr_last_name like @phrase)
...
INNER JOIN dbo.leads L ON A.act_lead_primary_lead_key = L.lea_key 
and (L.lea_isduplicate <> 1 OR L.lea_isduplicate IS NULL)
Where 
  (I.indv_last_name like @phrase)
